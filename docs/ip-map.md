...
| 5 | **Pi Zero 2 W — Watchdog Bot (รันจริง)** | `192.168.1.20` | `2c:cf:67:8e:f2:b1` | — | ✅ **cctv-bot active (WiFi)** | health 60s + poll Telegram + /snapshot /clip (rtsp sub `/1`) — สแกนคนฝาก Gateway; RAM 415MB จำกัด MemoryMax 320M, `record_on_person: false` กัน SD |
